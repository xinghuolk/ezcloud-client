export const projects = [
  {
    ...
    duration: '3 months',
    picture: 'https://media.cssninja.io/content/photos/abstracts/1.png',
    industry: 'HR Vetting',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    duration: '2 months',
    picture: 'https://media.cssninja.io/content/photos/abstracts/2.png',
    industry: 'Food',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    customer: 'Best Mart',
    duration: '6 months',
    picture: 'https://media.cssninja.io/content/photos/abstracts/3.png',
  ...
  },
  {
    ...
    duration: '1 month',
    picture: 'https://media.cssninja.io/content/photos/abstracts/4.png',
    industry: 'Clothing',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    customer: 'WorkForce',
    duration: '3 weeks',
    picture: 'https://media.cssninja.io/content/photos/abstracts/5.png',
    industry: 'Software',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    customer: 'WorkForce',
    duration: '3 weeks',
    picture: 'https://media.cssninja.io/content/photos/abstracts/6.png',
    industry: 'Software',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    duration: '5 months',
    picture: 'https://media.cssninja.io/content/photos/abstracts/7.png',
    industry: 'Retail',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    duration: '2 months',
    picture: 'https://media.cssninja.io/content/photos/abstracts/8.png',
    industry: 'Education',
    status: 'In Progress',
    team: [
      {
  ...
  },
  {
    ...
    customer: 'Freako',
    duration: '2 weeks',
    picture: 'https://media.cssninja.io/content/photos/abstracts/9.png',
    industry: 'Retail',
    status: 'In Progress',
    team: [
      {
